...
![Summary photo of code review workshop](/assets/images/code-review_summary.png)
...
|:--:| 
| *Screenshot of the padlet showing discussions from one of the code review exercises.* |
...
|![Event poster](/assets/images/code-review_poster.jpg)|
|:--:| 
